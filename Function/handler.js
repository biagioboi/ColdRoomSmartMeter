...
exports.handler = function(context, event) {
	...
	if (message_obj.current_temperature > message_obj.max_temperature) {
		rest.post('https://maker.ifttt.com/trigger/high_temperature/with/key/cweKjQyxdRO2yzwCWFSvL', {data: {value1: message_obj.current_temperature, value2: device_name}}).on('complete', function(data){
